...
function top_chart() {
    new Chart(document.getElementById("myChart1"), {
        type: 'line',
        data: {
            labels: ['10', '2022/11', '2022/12', '2023/01', '2023/02', '2023/03', '2023/04', '2023/05', '2023/06', '2023/07', '2023/08', '2023/09'],
font:{size:24},
            datasets: [
                {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (res[0].CollectState == '1') {
                            Optional_stock_btn.style.border = "none";
                            Optional_stock_btn.style.boxShadow = "none";
                            Optional_stock_btn.innerText = '';
                        }
                        else {
